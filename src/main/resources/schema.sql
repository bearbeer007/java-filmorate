DROP TABLE IF EXISTS
    film_genres, films, genres, like_films,
    ratings,likes, users, users_friendship,
    reviews, reviews_likes, directors,
    events, film_directors;
...
CREATE TABLE IF NOT EXISTS film_directors (
                                ...
                                CONSTRAINT film_directors_fdk PRIMARY KEY (film_id, director_id),
                                CONSTRAINT film_directors_film_fdk FOREIGN KEY (film_id) REFERENCES films(id),
                                CONSTRAINT film_directors_directors_fdk FOREIGN KEY (director_id) REFERENCES directors(id) on delete cascade
);
